...
I wanted a project where I could work on more than basic CRUD operations.

Finora gives me a chance to work with things I would normally encounter in a real Laravel application, including:
...
I'll be adding features and improving the architecture as development continues.
...
The backend is being developed first, followed by the React frontend.
